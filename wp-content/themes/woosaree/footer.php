                        ...
                        <div class="footer-infor">
                            <div class="footer-logo">
                                <a href="<?php echo home_url(); ?>">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/avon-logo.svg"
                                        width="311px" alt="duabooo">
                                </a>
                            </div>
                            <ul>
                                <li>
                                    <?php
                                    $footer_about = function_exists('woosaree_get_option') ? woosaree_get_option('footer_about') : '';
                                    $default_about = 'A modern kidswear brand blending comfort with timeless style. Crafted with care for playful days and special moments.';
                                    $display_about = !empty(trim($footer_about)) ? $footer_about : $default_about;
                                    ?>
                                    <p><?php echo esc_html($display_about); ?></p>
                                </li>
                                <!-- <li>
                    ...
                    <div class="col-12">
                        <div
                            ...
                            <div class="footer-menu_item">
                                <?php
                                $footer_copyright = function_exists('woosaree_get_option') ? woosaree_get_option('footer_copyright') : '';
                                $default_copyright = '©2026 Sansaree . All Rights Reserved';
                                $display_copyright = !empty(trim($footer_copyright)) ? $footer_copyright : $default_copyright;
                                echo esc_html($display_copyright);
                                ?>
                            </div>
                            <div class="tf-payment">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/payments/visa.png"
                                    alt="">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/payments/img-1.png"
                                    alt="">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/payments/img-2.png"
                                    alt="">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/payments/img-3.png"
                                    alt="">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/payments/img-4.png"
                                    alt="">
                            </div>
                        </div>
                    </div>
...
<div class="tf-toolbar-bottom type-1150">
    <div class="toolbar-item">
        <a href="<?php echo esc_url(get_post_type_archive_link('product') ?: home_url('/shop/')); ?>">
    ...
    <div class="mb-canvas-content">
        <div class="mb-body">
                            ...
                            <li><a href="#sub-account" class="sub-nav-link collapsed" data-bs-toggle="collapse"
                                ...
                                <div id="sub-account" class="collapse">
                                    <ul class="sub-nav-menu sub-menu-level-2">
                                        ...
                                        <li><a href="my-account-edit.html" class="sub-nav-link">My account details</a>
                                        </li>
            ...
            <!-- <div class="mb-other-content">
                ...
                <ul class="mb-info">
                    <li>A modern kidswear brand blending comfort with timeless style. Crafted with care for playful days
                        and special moments. </li>
                    ...
                    <div class="tf-mini-cart-main">
                        <div class="tf-mini-cart-sroll">
                            ...
                            if (function_exists('woosaree_render_mini_cart_items')) {
                                ...
                                echo '<div class="tf-mini-cart-items"></div>';
                            }
                            ?>
                        </div>
                    </div>
                    ...
                    <div dir="ltr" class="swiper tf-single-slide">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="item">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/sree-img/img/saree-pr/1/saree-v1.jpg"
                                        alt="">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="item">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/sree-img/img/saree-pr/1/saree-v2.jpg"
                                        alt="">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="item">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/sree-img/img/saree-pr/1/saree-v3.jpg"
                                        alt="">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="item">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/sree-img/img/saree-pr/1/saree-v4.jpg"
                                        alt="">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="item">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/sree-img/img/saree-pr/1/saree-v7.jpg"
                                        alt="">
                                </div>
                            </div>
                        </div>
