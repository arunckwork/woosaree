...
<head>
    <meta charset="utf-8">
    <title>Sansree - India's Saree Landmark </title>

    <meta name="author" content="themesflat.com">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">

    <!-- Favicon and Touch Icons  -->
    <link rel="shortcut icon" href="<?php echo get_stylesheet_directory_uri(); ?>/images/logo/favicon.png">
    <link rel="apple-touch-icon-precomposed"
        href="<?php echo get_stylesheet_directory_uri(); ?>/images/logo/favicon.png">
...
<body class="preload-wrapper">
    ...
    <!-- /preload -->
    <?php
    $phone_setting = function_exists('woosaree_get_option') ? woosaree_get_option('phone') : '';
    $clean_phone   = preg_replace('/[^0-9]/', '', $phone_setting);
    $whatsapp_num  = !empty($clean_phone) ? $clean_phone : '971567144510';
    ?>
    <a href="https://wa.me/<?php echo esc_attr($whatsapp_num); ?>?text=%20Welcome%20to%20Sansaree%20" class="whatsapp" target="_blank">
        <i class="fa fa-whatsapp whatsapp-icon"></i>
    </a>
    <div id="wrapper">
        <?php
        $announcements = function_exists('woosaree_get_option') ? woosaree_get_option('announcements', array()) : array();
        $valid_announcements = is_array($announcements) ? array_filter(array_map('trim', $announcements)) : array();
            ...
            <div class="announcement-bar bg_dark">
                <div class="wrap-announcement-bar">
                    <div class="box-sw-announcement-bar speed-1">
                        <?php foreach ($valid_announcements as $text): ?>
                ...
                <div class="row wrapper-header align-items-center">
                    ...
                    <div class="col-xl-3 col-md-4 col-6">
                        <a href="<?php echo home_url(); ?>" class="logo-header">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/avon-logo.svg" alt="logo"
                                class="logo">
                        </a>
                    </div>
...
?>
                            <!-- <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-30">
                                        ...
                                        <ul class="menu-list">
                                            <li>
                                                <a href="shop-default.html"
                                                    class="menu-link-text link text_black-2">Sarees</a>
                                            </li>


                                            <li><a href="shop-default.html"
                                                    class="menu-link-text link text_black-2 position-relative">Jewellers</a>
                                            </li>


                                            <li><a href="shop-default.html"
                                                    class="menu-link-text link text_black-2 position-relative">Cotton
                                                    saree</a></li>
                                            <li><a href="shop-default.html"
                                                    class="menu-link-text link text_black-2 position-relative">Kanjeevaram</a>
                                            </li>
                                ...
                                <li class="menu-item"><a href="contact-1.html" class="item-link">Contact</a></li>
                                    ...
                                    <div class="sub-menu submenu-default">
                                        <ul class="menu-list">
                                            ...
                                            <li><a href="faq-2.html"
                                                    class="menu-link-text link text_black-2 position-relative">FAQ</a>
                                            </li>
